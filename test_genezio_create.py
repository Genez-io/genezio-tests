...
import os
from genezio import genezio_deploy, genezio_login, genezio_local, genezio_create
...
def test_genezio_create():
	...
	for backend in backendVariants:
		for frontend in frontendVariants:
			to_create.append({"name": "test-" + backend + "-" + frontend, "region": "us-east-1", "backend": backend, "frontend": frontend})
	...
	for project in to_create:
		...
		assert process_local != None, "genezio local returned None"
